...
The backend is designed to be as stateless, allowing it be horizontally scalable. i.e. A client is able to send requests to any backend in a cluster without worrying about their session.
...
% What we've learnt and achieved.
...
\subsection{Hide inactive users}
